...
public class ConnectionPool {
    ...
    private static void init() {
        //先把jdbc配置文件加载到程序里
        PropertiesUtil2.load("jdbc");
        DRIVER = PropertiesUtil2.getValue("jdbc.driver");
        URL = PropertiesUtil2.getValue("jdbc.url");
        USERNAME = PropertiesUtil2.getValue("jdbc.userName");
        PASSWORD = PropertiesUtil2.getValue("jdbc.password");
        MIN_POOL_NUM = Integer.parseInt(PropertiesUtil2.getValue("jdbc.minPoolNum"));
        MAX_POOL_NUM = Integer.parseInt(PropertiesUtil2.getValue("jdbc.maxPoolNum"));
    }
